...
// Same file as Code.cpp but more hardcore
...
// Crypto++ libraries
// Add more stuff later, Crypto++ has lots of shit

// Libsodium library for ChaCha/Poly
// #include "libs/nacl-20110221/nacl-20110221/"
...
int main() {
   u8 key[16] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,
    ...
    start = __rdtsc();
    f8(key, count, bearer, dr, data, length);
    end = __rdtsc();
